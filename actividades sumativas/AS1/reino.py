...
class Reino:
    ...
    def avanzar_edad(self):
        ...
        for i in self.construcciones["Muro"]:
            i.avanzar_edad()
        for i in self.construcciones["Catapulta"]:
            i.avanzar_edad()
        for i in self.construcciones["MuroCatapulta"]:
            i.avanzar_edad()
        for i in self.construcciones["Barracas"]:
            i.avanzar_edad()
        # for i in self.construcciones.values():
        #     i.avanzar_edad()
